#first prompt is to identify suitable agent according to user query
#second promt to generate response
...
"""
#####-------For Router------####
#Function to integrate chat history to prompt
...
"""
    return system_prompt  #returning system prompt with chat history
